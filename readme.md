...
Данная система предназначена для тех людей, которые хотят быстро и бесплатно отредактировать свое изображение. 
...
__Пример:__ На видео ниже представлен пример применения интерполяции к изображению. <br>
🎥 <a href="https://img.youtube.com/vi/YOUTUBE_VIDEO_ID_HERE/0.jpg">Ссылка на демонстрационное видео.</a>
# Состав команды
__Состав команды:__
